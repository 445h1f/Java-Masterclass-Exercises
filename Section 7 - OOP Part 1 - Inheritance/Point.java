...
public class Point {
    ...
    public double distance(Point pointClass){
        double d = Math.sqrt(((pointClass.getX() - x) * (pointClass.getX() - x)) + ((pointClass.getY() - y) * (pointClass.getY() - y)));
        return d;
    }
