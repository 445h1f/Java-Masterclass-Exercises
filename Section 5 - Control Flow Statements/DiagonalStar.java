            ...
            for (int row=1; row<=number; row++){
                for (int col=1; col<=number; col++){
                    if (row == 1 || row == number || col == 1 || col == number){
                        // printing stars when row, col is 1 or row, col equals to number
                        System.out.print('*');
                    } else if (col == row){
                        // printing star whenever row is equal to column
                        System.out.print('*');
                    } else if (col == (number-row)+1){
                        // printing when col is number-row+1
                        System.out.print('*');
                    } else {
                        // printing spaces
                        System.out.print(' ');
                ...
                System.out.println(); //printing new line after col is completed to go to next row
            }
        }
    }
}